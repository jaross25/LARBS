...
# DEFAULTS:
[ -z ${dotfilesrepo+x} ] && dotfilesrepo="https://github.com/jaross25/voidrice.git"
[ -z ${progsfile+x} ] && progsfile="https://raw.githubusercontent.com/jaross25/LARBS/master/progs.csv"
